...
vm.loadProject(fs.readFileSync('../dist/ArenaClash.sb3')).then(async ()=>{
  ...
  vm.postIOData('mouse',{x:28+240,y:180+112,isDown:true,canvasWidth:480,canvasHeight:360}); step(1);
  vm.postIOData('mouse',{x:28+240,y:180+112,isDown:false,canvasWidth:480,canvasHeight:360}); step(6);
